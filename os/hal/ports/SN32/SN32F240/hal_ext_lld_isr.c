...
/**
 * @file    SN32F0xx/hal_ext_lld_isr.c
 * @brief   SN32F0xx EXT subsystem low level driver ISR code.
 *
 * @addtogroup EXT
 * @{
 */
...
#if !defined(SN32F030) || defined(__DOXYGEN__)
/**
...
#if !defined(SN32_DISABLE_EXTI171920_HANDLER)
/**
...
#if !defined(SN32F030) || defined(__DOXYGEN__)
#if !defined(SN32_DISABLE_EXTI2122_HANDLER)
/**
...
void ext_lld_exti_irq_enable(void) {
  ...
  nvicEnableVector(EXTI0_1_IRQn, SN32_EXT_EXTI0_1_IRQ_PRIORITY);
  nvicEnableVector(EXTI2_3_IRQn, SN32_EXT_EXTI2_3_IRQ_PRIORITY);
  nvicEnableVector(EXTI4_15_IRQn, SN32_EXT_EXTI4_15_IRQ_PRIORITY);
#if !defined(SN32F030) && !defined(SN32F070)
  nvicEnableVector(PVD_IRQn, SN32_EXT_EXTI16_IRQ_PRIORITY);
  nvicEnableVector(ADC1_COMP_IRQn, SN32_EXT_EXTI21_22_IRQ_PRIORITY);
#endif
  nvicEnableVector(RTC_IRQn, SN32_EXT_EXTI17_20_IRQ_PRIORITY);
}
